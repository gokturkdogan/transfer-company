...
export const createReservationInputSchema = z
  .object({
    ...
    passengerCount: positiveInt.max(50),
    infantCount: nonNegativeInt.max(50).optional().default(0),
    largeLuggageCount: nonNegativeInt.max(50),
    cabinLuggageCount: nonNegativeInt.max(50).default(0),
